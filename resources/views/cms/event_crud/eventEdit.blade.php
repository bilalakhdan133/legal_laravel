         ...
         <div class="row">
            <div
               ...
               <h1 class="display-7 mb-4 text-white">
                  Edit event {{ $eventDetails->nama_event }} 
               </h1>
            </div>
            <!-- /column -->
         </div>
                                    ...
                                    <div class="col-6">
                                       <div class="mb-3">
                                          ...
                                          <select class="form-select" name="KategoriEvent" aria-label="Default select example">
                                             ...
                                             <option value="{{ $evecat->id }}" {{ ($evecat->id == $eventDetails->eventCategory->id ) ? 'selected' : '' }} >
                                    ...
                                    <div class="col-6">
                                       <div class="mb-3">
                                          ...
                                          <input
                                             ...
                                             value="{{ $eventDetails->lokasi_event }}"
                                             />
                                             @error('LokasiEvent')
                                                <p class="text-red">
                                                    {{ $message }}
                                    ...
                                    <div class="col-6">
                                       <div class="mb-3">
                                          ...
                                          <input
                                             ...
                                             value="{{ $eventDetails->kuota_event }}"
                                             />
                                             @error('KuotaEvent')
                                                <p class="text-red">
                                                    {{ $message }}
                                    ...
                                    <div class="col-6">
                                       <div class="mb-3">
                                          ...
                                          <input
                                             ...
                                             id="TanggalEvent"
                                             name="TanggalEvent"
                                             value="{{ $eventDetails->tanggal_event }}"
                                             />
                                             @error('TanggalEvent')
                                                <p class="text-red">
                                                    {{ $message }}
                                    ...
                                    <div class="col-12">
                                       <div class="mb-3">
                                          ...
                                          <textarea
                                             ...
                                             >{{ $eventDetails->deskripsi_event }}</textarea>
