  ...
  @section('container')
    <div class="content-wrapper">
      ...
      <section class="wrapper bg-docan angled lower-start">
        <div
          ...
          <div class="container pt-7 pt-md-11 pb-8">
            <div class="row gx-0 gy-10">
              <div
                ...
                data-delay="100"
              >
                <h1 class="display-1 text-black mb-4">Document Analytics</h1>

                <p
                  class="lead fs-24 lh-sm text-black mb-7 pe-md-18 pe-lg-0 pe-xxl-15"
                >
                  Menganalisis & mengharmonisasikan dokumen dengan membandingkan
                  antar dokumen peraturan.
                </p>
              </div>
              <!-- /column -->
              <div class="col-lg-5 offset-lg-1 mb-n18" data-cues="slideInDown">
                <div class="position-relative">
                  <figure>
                    <img 
                    src="{{ URL::asset('/legal/image/product/da-docan-hero.png') }}"
                    alt="document analytics hero" 
                  />
                  </figure>
                </div>
                <!-- /div -->
        ...
        >
          ...
          >
            <div class="col-md-8 col-lg-6 position-relative">
              <figure class="rounded">
                <img
                    src="{{ URL::asset('/legal/image/product/da-automated-speed.png') }}"
                    alt="automated speed image" 
                />
              </figure>
            </div>
            <!--/column -->
            <div class="col-lg-5 col-xl-4 offset-lg-1">
              <h3 class="display-4 mb-7">Automated & Speed</h3>
              <div class="d-flex flex-row">
                <div>
                  <p class="mb-0">
                    Memberikan kecepatan dan automasi dalam menganalisis dan
                    mengharmonisasikan antar dokumen.
                  </p>
                </div>
              </div>
            </div>
          ...
          >
            ...
            >
              <figure class="rounded">
                <img
                  src="{{ URL::asset('/legal/image/product/da-advance-analytics.png') }}"
                    alt="advance analytics image" 
                />
              </figure>
            </div>
            ...
            <!--/column -->
            <div class="col-lg-5">
              <h3 class="display-4 mb-7">Advance Analytics</h3>
              <div class="d-flex flex-row">
                <div>
                  <p class="mb-0">
                    Menggunakan teknik analytics tingkat tinggi yang memudahkan
                    dalam menganalisis dan mengharmonisasikan antar dokumen.
                  </p>
                </div>
              </div>
            </div>
          ...
          >
            <div class="col-md-8 col-lg-6 position-relative">
              <figure class="rounded">
                <img
                src="{{ URL::asset('/legal/image/product/da-deep-learning.png') }}"
            ...
            <!--/column -->
            <div class="col-lg-5 col-xl-4 offset-lg-1">
              <h3 class="display-4 mb-7">Deep Learning</h3>
              <div class="d-flex flex-row">
                <div>
                  <p class="mb-0">
                    Penggunaan Deep learning dalam memberikan hasil analisa data
                    yang lebih baik performanya.
                  </p>
                </div>
              </div>
            </div>
