@extends('legal/main')
  @section('container')
    ...
    <div class="content-wrapper">
      ...
      <section class="wrapper bg-docsetdraf angled lower-start">
        <div
          ...
          <div class="container pt-7 pt-md-11 pb-8">
            <div class="row gx-0 gy-10">
              <div
                ...
                data-delay="100"
              >
                <h1 class="display-1 text-black mb-4">Document Setting & Drafting</h1>

                <p
                  class="lead fs-24 lh-sm text-black mb-7 pe-md-18 pe-lg-0 pe-xxl-15"
                >
                Melakukan penyusunan otomatis terhadap naskah rancangan sesuai dengan ketentuan.
                </p>
              </div>
              <!-- /column -->
              <div class="col-lg-5 offset-lg-1 mb-n18" data-cues="slideInDown">
                <div class="position-relative">
                  <figure>
                    <img 
                        src="{{ URL::asset('/legal/image/product/dsd-docsetdraf-hero.png') }}"
                        alt="document setting and drafting hero"
                     />
                  </figure>
                </div>
                <!-- /div -->
        ...
        >
          ...
          >
            <div class="col-md-8 col-lg-6 position-relative">
              <figure class="rounded">
                <img
                      src="{{ URL::asset('/legal/image/product/dsd-accuracy.png') }}"
                      alt="accuracy image"
                />
              </figure>
            </div>
            ...
            <div class="col-lg-5 col-xl-4 offset-lg-1">
              <h3 class="display-4 mb-7">Accuracy</h3>
              <div class="d-flex flex-row">
                <div>
                  <p class="mb-0">
                    Terkait typo dokumen jadi benar setelah di upload
                  </p>
                </div>
              </div>
            </div>
          ...
          >
            ...
            >
              <figure class="rounded">
                <img
                src="{{ URL::asset('/legal/image/product/dsd-upload-download.png') }}"
                      alt="upload and download image"
                />
              </figure>
            </div>
            ...
            <!--/column -->
            <div class="col-lg-5">
              <h3 class="display-4 mb-7">Upload & Download</h3>
              <div class="d-flex flex-row">
                <div>
                  <p class="mb-0">
                    Memungkinkan orang untuk upload & download
                  </p>
                </div>
              </div>
            </div>
          ...
          >
            <div class="col-md-8 col-lg-6 position-relative">
              <figure class="rounded">
                <img
                src="{{ URL::asset('/legal/image/product/dsd-automatic-template.png') }}"
                      alt="automatic template image"
                />
              </figure>
            </div>
            <!--/column -->
            <div class="col-lg-5 col-xl-4 offset-lg-1">
              <h3 class="display-4 mb-7">Automatic Template</h3>
              <div class="d-flex flex-row">
                <div>
                  <p class="mb-0">
                    Memungkinkan untuk mengunggah dokumen secara mudah dan otomatis
                  </p>
                </div>
              </div>
            </div>
