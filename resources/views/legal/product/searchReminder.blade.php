@extends('legal/main')
  ...
  <body>
    <div class="content-wrapper">
      ...
      <section class="wrapper bg-searemind angled lower-start">
        <div
          ...
          <div class="container pt-7 pt-md-11 pb-8">
            <div class="row gx-0 gy-10">
              <div
                ...
                data-delay="100"
              >
                <h1 class="display-1 text-black mb-4">Search & Reminder</h1>

                <p
                  class="lead fs-24 lh-sm text-black mb-7 pe-md-18 pe-lg-0 pe-xxl-15"
                >
                Melakukan pencarian pada dokumen tertentu, serta menampilkan daftar dokumen yang harus diselesaikan.
                </p>
              </div>
              <!-- /column -->
              <div class="col-lg-5 offset-lg-1 mb-n18" data-cues="slideInDown">
                <div class="position-relative">
                  <figure>
                    <img 
                      src="{{ URL::asset('/legal/image/product/sr-seanrem-hero.png') }}"
                      alt="search and reminder hero" 
                      />
                  </figure>
                </div>
                <!-- /div -->
        ...
        >
          ...
          >
            <div class="col-md-8 col-lg-6 position-relative">
              <figure class="rounded">
                <img
                src="{{ URL::asset('/legal/image/product/sr-relevance-search.png') }}"
                      alt="relevance search image" 
                />
              </figure>
            </div>
            <!--/column -->
            <div class="col-lg-5 col-xl-4 offset-lg-1">
              <h3 class="display-4 mb-7">Relevance Search</h3>
              <div class="d-flex flex-row">
                <div>
                  <p class="mb-0">
                    Hasil pencarian sesuai dengan keyword yang dicari.
                  </p>
                </div>
              </div>
            </div>
          ...
          >
            ...
            >
              <figure class="rounded">
                <img
                      src="{{ URL::asset('/legal/image/product/sr-attractive-filtering.png') }}"
                      alt="attractive filtering image" 
                />
              </figure>
            </div>
            ...
            <!--/column -->
            <div class="col-lg-5">
              <h3 class="display-4 mb-7">Attractive Filtering</h3>
              <div class="d-flex flex-row">
                <div>
                  <p class="mb-0">
                    Pilihan filter pencarian yang memudahkan user dalam memilah dokumen.
                  </p>
                </div>
              </div>
            </div>
          ...
          >
            <div class="col-md-8 col-lg-6 position-relative">
              <figure class="rounded">
                <img
                src="{{ URL::asset('/legal/image/product/sr-alert-notification.png') }}"
                      alt="alert and notification image"
                />
              </figure>
            </div>
            <!--/column -->
            <div class="col-lg-5 col-xl-4 offset-lg-1">
              <h3 class="display-4 mb-7">Alert and Notification</h3>
              <div class="d-flex flex-row">
                <div>
                  <p class="mb-0">
                    Memberikan notifikasi untuk mengingatkan user terkait waktu penyelesaian penyusunan peraturan perundangan-undangan
                  </p>
                </div>
              </div>
            </div>
          ...
          >
            ...
            >
              <figure class="rounded">
                <img
                src="{{ URL::asset('/legal/image/product/sr-document-insight.png') }}"
                      alt="document insight image"
                />
              </figure>
            </div>
            ...
            <!--/column -->
            <div class="col-lg-5">
              <h3 class="display-4 mb-7">Document Insight</h3>
              <div class="d-flex flex-row">
                <div>
                  <p class="mb-0">
                    Memberikan informasi & analisa pada setiap dokumen hasil pencarian.
                  </p>
                </div>
              </div>
            </div>
          ...
          >
            <div class="col-md-8 col-lg-6 position-relative">
              <figure class="rounded">
                <img
                src="{{ URL::asset('/legal/image/product/sr-download-document.png') }}"
                      alt="download document image"
                />
              </figure>
            </div>
            <!--/column -->
            <div class="col-lg-5 col-xl-4 offset-lg-1">
              <h3 class="display-4 mb-7">Download Document</h3>
              <div class="d-flex flex-row">
                <div>
                  <p class="mb-0">
                    Memungkinkan untuk user mendownload hasil dokumen dari suatu pencarian.
                  </p>
                </div>
              </div>
            </div>
