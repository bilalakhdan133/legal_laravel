...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{ url('/css/flagPhoneStyle.css') }}">
    </head>

    <body>
        @include('legal/header') @yield('container') @include('legal/footer')
        ...
        ></script>
        <script src="{{ url('/js/jquery.ddslick.js') }}"></script>
        <script>
            $("#interPhone").ddslick({
                width: "120px",
                imagePosition: "left",
